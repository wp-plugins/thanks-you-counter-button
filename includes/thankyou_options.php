...
<?php thanks_displayBoxStart(__('Greetings:','thankyou')); ?>
              ...
              <a class="thanks_rsb_link" style="background-image:url(<?php echo THANKS_PLUGIN_URL.'/images/ogi.png'; ?>)" target="_blank" title="<?php _e("For the help with Serbian translation", 'ure'); ?>" href="http://firstsiteguide.com">Ogi</a>
