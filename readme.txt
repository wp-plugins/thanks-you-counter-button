...
Admin dashboard and sidebar widgets with list of latest thanked or the largests thanked posts (between 5 and 15) are available. Use widgets control panels to change settings according to your preferences. Admin dashboard widget has a Configure link on its title bar, just move mouse over it.
