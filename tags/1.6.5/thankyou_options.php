...
?>
				<div id="poststuff" class="metabox-holder has-right-sidebar">
					<div class="inner-sidebar" >
                      ...
                      <a class="thanks_rsb_link" style="background-image:url(<?php echo THANKS_PLUGIN_URL.'/images/ugo.png'; ?>);" target="_blank" title="<?php _e('for the help with Italian translation', 'thankyou'); ?>" href="http://www.myeasywp.com">www.myeasywp.com</a>
